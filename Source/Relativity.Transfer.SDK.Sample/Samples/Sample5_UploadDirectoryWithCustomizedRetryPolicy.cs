namespace Relativity.Transfer.SDK.Sample.Samples
{
	...
	internal class Sample5_UploadDirectoryWithCustomizedRetryPolicy : SampleBase
	{
		public Sample5_UploadDirectoryWithCustomizedRetryPolicy(ConsoleHelper consoleHelper) : base(consoleHelper) { }
