namespace Relativity.Transfer.SDK.Sample.Samples
{
	...
	internal class Sample4_UploadSingleFile : SampleBase
	{
		public Sample4_UploadSingleFile(ConsoleHelper consoleHelper) : base(consoleHelper) { }
		...
		public override async Task ExecuteAsync()
		{
			...
			FilePath sourcePath = _consoleHelper.EnterSourceFilePathOrTakeDefault();
			...
			TransferJobResult result = await transferClient
				.UploadFileAsync(transferJobId, sourcePath, destinationPath, ConsoleStatisticHook.GetProgressHandler(), default)
