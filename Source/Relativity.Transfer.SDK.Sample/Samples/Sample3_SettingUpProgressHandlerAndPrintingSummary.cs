namespace Relativity.Transfer.SDK.Sample.Samples
{
	...
	internal class Sample3_SettingUpProgressHandlerAndPrintingSummary : SampleBase
	{
		...
		public override async Task ExecuteAsync()
		{
			...
			DirectoryPath sourcePath = CreateTemporaryDirectoryWithFiles(transferJobId.ToString(), smallFilesAmountToUpload, largeFilesAmountToUpload, largeFileSize);
		...
		{
			string sampleDirectory = SourceFilesHelper.CreateDirectoryWithFiles(directoryName, smallFilesAmount, largeFilesAmount, largeFileSize);
