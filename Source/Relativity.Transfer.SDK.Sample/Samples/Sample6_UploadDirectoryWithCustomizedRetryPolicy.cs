namespace Relativity.Transfer.SDK.Sample.Samples
{
	...
	public class Sample6_UploadDirectoryWithCustomizedRetryPolicy : SampleBase
	{
		...
		public async override Task ExecuteAsync()
		{
			...
			// UploadDirectoryOptions with exponential exclusion policy 
			...
			TransferJobResult result = await transferClient
				.UploadDirectoryAsync(transferId, sourcePath, destinationPath, exponentialRetryPolicyOptions, GetProgressHandler(), default)
