namespace Relativity.Transfer.SDK.Sample.Samples
{
	...
	internal class Sample2_SettingUpProgressHandlerAndPrintingSummary : SampleBase
	{
		public Sample2_SettingUpProgressHandlerAndPrintingSummary(ConsoleHelper consoleHelper) : base(consoleHelper) { }
