namespace Relativity.Transfer.SDK.Sample.Samples
{
	...
	internal class Sample6_UploadDirectoryWithExclusionPolicy : SampleBase
	{
		public Sample6_UploadDirectoryWithExclusionPolicy(ConsoleHelper consoleHelper) : base(consoleHelper) { }
		...
		public override async Task ExecuteAsync()
		{
			...
			var sourcePath = CreateTemporaryDirectoryWithFiles(transferJobId.ToString(), "file1.xls", "file2.bin", "file3.doc", "file4.exe", "file5.txt", "file6.xml");
